- `resources/views/admin/welcome.blade.php`を編集<br>
...
- `resources/views/admin/auth/confirm-password.blade.php`<br>
...
- `resources/views/admin/auth/forgot-password.blade.php`を編集<br>
...
- `resources/views/admin/auth/register.blade.php`を編集<br>
...
- `resources/views/admin/auth/reset-password.blade.php`を編集<br>
...
- `resources/views/admin/atudh/verify-email.blade.php`を編集<br>
...
Route::get('/', function () {
  return view('user.welcome'); // 編集
});

Route::get('/dashboard', function () {
  return view('user.dashboard'); // 編集
})
...
Route::get('/', function () {
  return view('owner.welcome'); // 編集
});

Route::get('/dashboard', function () {
  return view('owner.dashboard'); // 編集
})
...
Route::get('/', function () {
  return view('admin.welcome'); // 編集
});

Route::get('/dashboard', function () {
  return view('admin.dashboard'); // 編集
})
...
- `resources/views/owner/auth/login.blade.php`を編集<br>
