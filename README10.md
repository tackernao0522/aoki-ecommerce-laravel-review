- `resources/views/owner/welcome.blade.php`を編集<br>
...
- `resources/views/owner/auth/confirm-password.blade.php`を編集<br>
...
- `resources/views/owner/auth/forgot-password.blade.php`を編集<br>
...
- `resources/views/owner/auth/register.blade.php`を編集<br>
...
- `resources/views/owner/auth/reset-password.blade.php`を編集<br>
...
- `resources/views/owner/auth/verify-email.blade.php`を編集<br>
